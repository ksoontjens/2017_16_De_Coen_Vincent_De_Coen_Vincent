...
public class PacmanVeld {
    ...
    public void recreate(){
        ...
        //moet zo recreaten anders pakt hij gwn by reference
        this.veld = new String[]{
            "----------------------------",
            "-************--************-",
            "-*----*-----*--*-----*----*-",
            "-*----*-----*--*-----*----*-",
    ...
    public boolean buildVeld(Graphics g, HComponent context) {
        ...
        if(!start){
            ...
            g.drawString("Typ <up> knop om te herstarten!", 150, 300);
            return false;
        }
